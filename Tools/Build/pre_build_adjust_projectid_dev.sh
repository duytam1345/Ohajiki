...
ls -l ${WORKSPACE}/Assets/FirebaseConfig/GoogleService-Info-dev.plist* ${WORKSPACE}/Assets/FirebaseConfig/GoogleService-Info.plist*
cp -v ${WORKSPACE}/Assets/FirebaseConfig/GoogleService-Info-dev.plist ${WORKSPACE}/Assets/FirebaseConfig/GoogleService-Info.plist
cp -v ${WORKSPACE}/Assets/FirebaseConfig/GoogleService-Info-dev.plist.meta ${WORKSPACE}/Assets/FirebaseConfig/GoogleService-Info.plist.meta
ls -l ${WORKSPACE}/Assets/FirebaseConfig/google-services-dev.json* ${WORKSPACE}/Assets/FirebaseConfig/google-services.json*
cp -v ${WORKSPACE}/Assets/FirebaseConfig/google-services-dev.json ${WORKSPACE}/Assets/FirebaseConfig/google-services.json
cp -v ${WORKSPACE}/Assets/FirebaseConfig/google-services-dev.json.meta ${WORKSPACE}/Assets/FirebaseConfig/google-services.json.meta
