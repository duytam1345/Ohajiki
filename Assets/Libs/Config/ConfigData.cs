...
namespace HyperCasualTemplate
{
    public class ConfigData : MonoBehaviour
    {
        ...
        public static AppLanguage _UserLanguage
        {
            get { return (AppLanguage)PlayerPrefs.GetInt("UserLanguage", 0); }
            set
            {
                PlayerPrefs.SetInt("UserLanguage", (int)value);
                PlayerPrefs.Save();
                if (LocalizeText.instance != null)
                {
                    LocalizeText.instance.UpdateCurrentData();
                }
            }
        }
        ...
        public static SystemLanguage UserLanguage
        {
            get
            {
                ...
                {
                    case AppLanguage.SystemLanguage:
                        return Application.systemLanguage;
                    case AppLanguage.English:
                        return SystemLanguage.English;
                    case AppLanguage.Japanese:
                        return SystemLanguage.Japanese;
                    case AppLanguage.Chinese_SC:
                        return SystemLanguage.ChineseSimplified;
                    case AppLanguage.Chinese_TC:
